...
//  unitTestProject
//
//  Created by Сергей Бондарчук on 04.06.2020.
...
class NegativeTests: XCTestCase {
    ...
    func testTelemedEvent() {
        // given
        setUp(eventType: Event(type: .telemed, date: Date()) , returnValue: "Сегодня не")
        // then
    ...
    func testDoctorEvent() {
        // given
        setUp(eventType: Event(type: .doctor, date: Date()) , returnValue: "Сегодня не")
        // then
    ...
    func testPillsEvent() {
        // given
        setUp(eventType: Event(type: .pills, date: Date()) , returnValue: "Сегодня не")
        // then
